  ...
  return (
    <div className="min-h-screen bg-gray-50">
      ...
      <main className="max-w-7xl mx-auto px-4 py-8">
        <div className="mb-8">
          <h2 className="text-3xl font-bold mb-2">{t('student.greeting', { name: 'Wei Ling' })}</h2>
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-8">
          <Card>
            <div className="flex items-center justify-between">
              <div>
                <p className="text-sm text-gray-600">{t('student.streak.label')}</p>
          ...
          <Card>
            <div>
              <p className="text-sm text-gray-600">{t('student.xp.label')}</p>
              <p className="text-3xl font-bold text-secondary-600">275 XP</p>
              <p className="text-xs text-gray-500">{t('student.xp.level', { level: 3 })}</p>
            </div>
          </Card>
